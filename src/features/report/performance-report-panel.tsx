...
import { draftConceptNoteStreaming } from '@/services/concept-note'
import { buildFiguresBlock } from './figures'
import { downloadPerformanceReportDocx } from '@/documents/performance-report'

import { formatPeriod, periodRange, today } from '@/domain/dates'
