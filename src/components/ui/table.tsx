...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        // Warm wash on hover rather than the stock grey — a neutral tint on a
        // cream ground reads as a rendering artefact.
        "border-b border-border-soft transition-colors hover:bg-brand-soft/45 has-aria-expanded:bg-brand-soft/45 data-[state=selected]:bg-brand-soft",
        className
      )}
      {...props}
    />
